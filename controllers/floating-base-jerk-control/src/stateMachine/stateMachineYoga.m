function  [w_H_b, CoM_des, qj_des, constraints, impedances, dampings, KPCoM, KDCoM, currentState, jointsSmoothingTime] = ...
    ...
    if state == 2 
        ...
        if norm(CoM_Error(2)) < Sm.CoM_threshold && wrench_rightFoot(3) < Sm.wrench_thresholdContactOff && wrench_leftFoot(3) < Sm.wrench_minVerticalForceOneFoot
