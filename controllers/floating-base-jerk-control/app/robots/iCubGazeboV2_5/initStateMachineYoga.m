...
Gain.KP_COM = [50    50  10  % state ==  1  TWO FEET BALANCING
               ...
               50    50  20  % state ==  5  PREPARING FOR SWITCHING 
               50    50  20  % state ==  6  LOOKING FOR CONTACT
...
Gain.impedances  = [10   30   20,  20   20    20   20,  20   20    20   20,  30   30   20   20   100 100,  30   50   30   60   100  100   % state ==  1  TWO FEET BALANCING
                    ...
                    30   30   30,  10   10    10   10,  10   10    10   10,  100  100  100  100  100 100,  100  50   30   100  100  100   % state ==  4  YOGA LEFT FOOT 
                    30   30   30,   5    5    10   10,  10   10    20   10,  200  150  20   20   10  50,   220  350  120  200  65   100   % state ==  5  PREPARING FOR SWITCHING 
                    30   30   30,  10   10    20   10,  10   10    20   10,  100  250  20   200  10  100,  220  350  120  200  65   100   % state ==  6  LOOKING FOR CONTACT
...
Gain.dampings = 2*sqrt(Gain.impedances)/20;  
...
Sm.CoM_delta       = [% THIS REFERENCE IS USED AS A DELTA W.R.T. THE POSITION OF THE LEFT FOOT
                      ...
                      0.0,  0.005, 0.06;  %% state ==  4  YOGA LEFT FOOT
                      0.0,  0.00, -0.01;  %% state ==  5  PREPARING FOR SWITCHING
                      0.0, -0.05, -0.015; %% state ==  6  LOOKING FOR CONTACT 
...
Sm.joints_references = [ zeros(1,ROBOT_DOF);                                %% THIS REFERENCE IS IGNORED 
                                 ...
                                 [-0.0348,0.0779,0.0429, ...                          %% state == 5  PREPARING FOR SWITCHING
                                  -0.1493,0.8580,0.2437,0.8710, ...                   %
                                  -0.1493,0.8580,0.2437,0.8710, ...                   %
                                  -0.0015,-0.1109,-0.0341,0.0003,0.0160,0.1630, ...   %  
                                   0.0005,0.0793,-0.0014,-0.0051,0.0073,-0.1151];     % 
...
q1 =        [-0.0790,0.2279, 0.4519, ...
             ...
             -1.0717,1.2904,-0.2447, 1.0948, ...
              0.2092,0.2060, 0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3484,0.4008,-0.0104,-0.3672,-0.1060,-0.0875];

q2 =        [-0.0790,0.2279, 0.4519, ...
             -1.1621,0.6663, 0.4965, 0.9947, ...
             -1.0717,1.2904,-0.2493, 1.0948, ...
              0.2092,0.2060, 0.0106,-0.1741,-0.0944,0.0700, ... 
              0.3714,0.9599, 1.2253,-1.6594,-0.1060,-0.0614];
          
q3 =        [-0.0852,-0.4273,0.0821,...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092,0.2060, 0.0106,-0.1741,-0.0944,0.0700, ...
              0.3714,0.9599, 1.2253,-1.6594, 0.5000,-0.0614];
          
q4 =        [-0.0852,-0.4273,0.0821,...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.3473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3514, 1.3107,1.2253,-0.0189, 0.5000,-0.0614];
          
q5 =        [-0.0790,-0.2273,0.4519, ...
             -1.1621,0.6663, 0.4965, 0.9947, ...
             -1.0717,1.2904,-0.2493, 1.0948, ...
              0.2092, 0.4473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3514, 1.3107,1.2253,-0.0189, 0.5000,-0.0614];
          
q6 =        [-0.0852,-0.4273,0.0821, ...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3514, 1.3107,1.2253,-0.0189, 0.5000,-0.0614];
...
q7 =        [-0.0852,-0.4273,0.0821, ...
             ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3514, 1.3107,1.2253, -1.6217, 0.5000,-0.0614];
...
q9 =        [-0.0852,-0.4273,0.0821, ...
             ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.3514, 0.0107,1.2253,-0.0189, 0.5000,-0.0614];
...
q11 =        [-0.0852,-0.4273,0.0821, ...
             ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.8514, 1.3107,1.2253,-0.0189, 0.5000,-0.0614];

q12 =        [-0.0852,-0.4273,0.0821, ...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.8514, 0.3107,1.2253,-0.0189, 0.5000,-0.0614];
...
q14 =        [-0.0852,-0.4273,0.0821, ...
             ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.8514, 0.0107,1.2253,-0.0189, 0.5000,-0.0614];
          
q15 =        [-0.0852,-0.4273,0.0821, ...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              1.5514, 0.3107,1.2253,-0.0189, 0.5000,-0.0614];
          
q16 =        [-0.0852,-0.4273,0.0821, ...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
              0.2514, 0.0107,1.2253,-0.0189, 0.5000,-0.0614];
          
q17 =        [-0.0852,-0.4273,0.0821, ...
              0.1391, 1.4585,0.2464, 0.3042, ...
             -0.4181, 1.6800,0.7373, 0.3031, ...
              0.2092, 0.6473,0.0106,-0.1741,-0.0944, 0.0700, ...
             -0.3514, 0.3107,1.2253,-0.0189, 0.5000,-0.0614];
