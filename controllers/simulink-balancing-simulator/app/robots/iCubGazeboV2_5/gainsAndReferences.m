...
for k = 1:size(Gain.KP_postural,1)
    
    Gain.KP_postural(k,12:end) = Gain.KP_postural(1,12:end);
end
...
StateMachine.CoM_delta  = [% THIS REFERENCE IS USED AS A DELTA W.R.T. THE POSITION OF THE LEFT FOOT
                           ...
                           0.0,  0.005, 0.08;  %% state ==  4  YOGA LEFT FOOT
                           0.0,  0.00,  0.0;   %% state ==  5  PREPARING FOR SWITCHING
                           0.0, -0.02,  0.0;   %% state ==  6  LOOKING FOR CONTACT 
