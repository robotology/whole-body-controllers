...
% OVERWRITE SOME CONFIGURATION PARAMETERS FOR RUNNING THE EXAMPLE_STATE_MACHINE DEMO
if strcmp(DEMO_TYPE,'EXAMPLE_STATE_MACHINE')
    ...
    Config.smoothingTime_CoM    = [2;2;2;2;2;2;2];
    Config.smoothingTime_LFoot  = [2;2;2;2;2;2;2];
    Config.smoothingTime_RFoot  = [2;2;2;2;2;2;2];
    Config.smoothingTime_joints = [2;2;2;2;2;2;2];

    % Gains that will influence the smoothing of reference orientations. The
    % higher, the faster. Only positive or null values.
    Config.LFoot_Kp_smoothing    = [1;1;1;1;1;1;1];
    Config.LFoot_Kd_smoothing    = [1;1;1;1;1;1;1];
    Config.RFoot_Kp_smoothing    = [1;1;1;1;1;1;1];
    Config.RFoot_Kd_smoothing    = [1;1;1;1;1;1;1];
    Config.rot_task_Kp_smoothing = [1;1;1;1;1;1;1];
    Config.rot_task_Kd_smoothing = [1;1;1;1;1;1;1];

    % Smoothing time for gain scheduling [s].
    Config.smoothingTimeGains    = [1;1;1;1;1;1;1];
    ...
    Gains.Kp_CoM = [50, 50, 50; ...  % state = 1 two feet balancing
                    ...
                    50, 50, 50; ...  % state = 4 move right foot origin
                    50, 50, 50; ...  % state = 5 move right foot orientation
                    50, 50, 50; ...  % state = 6 move right foot back
                    50, 50, 50];     % state = 7 two feet balancing
    ...
    Gains.Kp_LFoot =   [50, 50, 50, 30, 30, 30; ...  % state = 1 two feet balancing
                        ...
                        50, 50, 50, 30, 30, 30; ...  % state = 4 move right foot origin
                        50, 50, 50, 30, 30, 30; ...  % state = 5 move right foot orientation
                        50, 50, 50, 30, 30, 30; ...  % state = 6 move right foot back
                        50, 50, 50, 30, 30, 30];     % state = 7 two feet balancing
    ...
    Gains.Kp_rot_task = [20, 20, 20; ...  % state = 1 two feet balancing
                         ...
                         20, 20, 20; ...  % state = 4 move right foot origin
                         20, 20, 20; ...  % state = 5 move right foot orientation
                         20, 20, 20; ...  % state = 6 move right foot back
                         20, 20, 20];     % state = 7 two feet balancing
    ...
    Gains.impedances = [20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 1 two feet balancing          
                        20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 2 move CoM on left foot
                        20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 3 left foot balancing
                        20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 4 move right foot origin        
                        20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 5 move right foot orientation
                        20  20  20,  10  10  10  8,  10  10  10  8,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 6 move right foot back
