...
if strcmp(DEMO_TYPE,'MPC_WALKING')
    ...
    Gains.Kp_CoM = [50, 50, 50; ...      % state = 1 two feet balancing
                    ...
                    50, 50, 50]/0.8;     % state = 3 right foot balancing
                
    Gains.Kd_CoM = 2*sqrt(Gains.Kp_CoM)*0;
    ...
    Gains.Kp_LFoot = [50, 50, 50, 20, 20, 20; ... % state = 1 two feet balancing
                      ...
                      50, 50, 50, 20, 20, 20]/2;  % state = 3 right foot balancing
              
    Gains.Kd_LFoot = 2*sqrt(Gains.Kp_LFoot)*0;

    Gains.Kp_RFoot = [50, 50, 50, 20, 20, 20; ... % state = 1 two feet balancing
                      50, 50, 50, 20, 20, 20; ... % state = 2 left foot balancing
                      50, 50, 50, 20, 20, 20]/2;    % state = 3 right foot balancing

    Gains.Kd_RFoot = 2*sqrt(Gains.Kp_RFoot)*0; 
    ...
    Gains.Kp_rot_task = [20, 20, 20; ...  % state = 1 two feet balancing
                         ...
                         20, 20, 20]/2;     % state = 3 right foot balancing
                 
    Gains.Kd_rot_task =  2*sqrt(Gains.Kp_rot_task)*0; 

    % Joint position and velocity gains
    
                        % torso      % left arm      % right arm     % left leg               % right leg                                   
    Gains.impedances = [20  20  20,  20  20  20  20,  20  20  20  20,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 1 two feet balancing          
                        20  20  20,  20  20  20  20,  20  20  20  20,  30  30  30  60  10  10,  30  30  30  60  10  10;  ... % state = 2 left foot balancing
                        20  20  20,  20  20  20  20,  20  20  20  20,  30  30  30  60  10  10,  30  30  30  60  10  10]; ... % state = 3 right foot balancing
