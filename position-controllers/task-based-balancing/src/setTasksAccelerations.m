...
%        in a Simulink model.
%
% FORMAT: acc_task_star = setTasksAccelerations(pos_vel_acc_CoM_des,pose_vel_acc_LFoot_des,pose_vel_acc_RFoot_des,orient_vel_acc_rot_task_des, ...
%                                               pos_vel_CoM, pose_vel_LFoot, pose_vel_RFoot, orient_vel_rot_task, ...
%                                               Kp_Kd_CoM, Kp_Kd_LFoot, Kp_Kd_RFoot, Kp_Kd_rot_task, useFeetPIDs, Sat)    
%
