...
Sm.CoM_delta       = [% THIS REFERENCE IS USED AS A DELTA W.R.T. THE POSITION OF THE LEFT FOOT
                      ...
                      0.0, -0.012, 0.0;   %% state == 10  YOGA RIGHT FOOT
...
Kbemf = [0.0008 0.001  0.0008 ...                        % torso
         0.0015 0.0003 0.0004 0.0004 ...                 % left arm
         0.0016 0.0004 0.0004 0.0004 ...                 % right arm
         0.0035 0.002  0.0    0.002  0.0025  0.0025 ...  % left leg
         0.004  0.002  0.0    0.002  0.0025  0.0025];    % right leg
