...
In order to run the simulation of iCub standing up from a chair, make sure you have installed on your pc the following dependencies:
 ...
 It is suggested to install the above mentioned repository using [robotology-superbuild](https://github.com/robotology/robotology-superbuild) (enable `ROBOTOLOGY_ENABLE_DYNAMICS`, `CODYCO_USES_GAZEBO` and `CODYCO_USES_MATLAB` options).
